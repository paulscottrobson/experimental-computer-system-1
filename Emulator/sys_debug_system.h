...
#define WIN_TITLE 		"ECS Emulator"												// Initial Window stuff
...
#define DEBUG_KEYMAP(k,r) 	DBGXProcessDebugKey(k,r)								// Runtime can remap/process keys etc.
...
#define DBGXProcessDebugKey(k,m) HWIProcessKey(k,m)
